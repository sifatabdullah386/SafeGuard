...
import com.smilesifat.eselfredeemer.homeScreen.FireStations;
import com.smilesifat.eselfredeemer.homeScreen.HelpActivity;
import com.smilesifat.eselfredeemer.R;
import com.smilesifat.eselfredeemer.homeScreen.TotalUsers;
import com.smilesifat.eselfredeemer.homeScreen.TrafficAccidents;
...
public class AlertTag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        FeedBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getActivity(), com.smilesifat.eselfredeemer.homeScreen.FeedBack.class);
                startActivity(intent);
            }
        });
        PoliceStations.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getActivity(), com.smilesifat.eselfredeemer.homeScreen.PoliceStations.class);
                startActivity(intent);
            }
        });
        EmergencyMedical.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getActivity(), com.smilesifat.eselfredeemer.homeScreen.EmergencyMedical.class);
                startActivity(intent);
            }
        });
        SexualHarassment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getActivity(), com.smilesifat.eselfredeemer.homeScreen.SexualHarassment.class);
                startActivity(intent);
            }
        });
