...
public class addHospitals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_hospitals_layout);
    ...
    public void AddHospitalData(){
        ...
        assert id != null;
        addHospitalReferences.child(id).setValue(new addHospitalsConstructor(HospitalNameData,HospitalLocationData,HospitalPhoneNumberData,HospitalEmailData,HospitalTypeData,HospitalDescriptionData));
